  ...
  sendOTP: async (email, firstName = '') => {
    try {
      ...
      const mailOptions = {
        ...
        to: email,
        subject: '🔐 Mã OTP xác thực tài khoản - Studivo LMS',
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
            <div style="text-align: center; margin-bottom: 30px;">
              <h1 style="color: #2c3e50;">📚 Studivo LMS</h1>
            </div>
            
            <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
              <h2 style="color: #2c3e50; margin-top: 0;">Xin chào ${firstName}!</h2>
              <p style="font-size: 16px; line-height: 1.5; color: #555;">
                Cảm ơn bạn đã đăng ký tài khoản tại <strong>Studivo LMS</strong>. 
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; text-align: center;">
              <p style="color: #888; font-size: 14px;">
                ...
                Mọi thắc mắc, liên hệ: <a href="mailto:support@studivo.com">support@studivo.com</a>
              </p>
              <p style="color: #888; font-size: 12px; margin-top: 15px;">
                © 2024 Studivo LMS. All rights reserved.
              </p>
            </div>
          </div>
        `
