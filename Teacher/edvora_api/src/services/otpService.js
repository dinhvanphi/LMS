    ...
    if (isPasswordReset) {
      htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          <h2 style="color:rgb(216, 20, 20);">Edvora - Đặt lại mật khẩu</h2>
          <p>Bạn đã yêu cầu đặt lại mật khẩu trên Edvora.</p>
          ...
          <p>Trân trọng,<br>Đội ngũ Edvora</p>
        </div>
      `;
    } else {
      htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          <h2 style="color:rgb(168, 18, 18);">Edvora - Xác thực tài khoản</h2>
